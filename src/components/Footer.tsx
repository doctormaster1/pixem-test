...
export function Footer() {
  const navigation = ["Ana Sayfa", "Hizmetlerimiz", "S.S.S"];
    ...
    <div className="relative">
      <Container>
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright © {new Date().getFullYear()} Pixem. Tüm hakları saklıdır.
        </div>
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400"></div>
      </Container>
    </div>
  );
}
